<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8" import="ma.fstt.entities.Produit"%>
    <%Produit a=(Produit) request.getAttribute("c"); %>
<!DOCTYPE html>
<html>
<head>
<style>
...
<div class="card">
  ...
  <div class="mb-3">
    ...
    <input type="text" class="form-control" name="prix" id="exampleInputPassword1" value=<%=a.getPrix() %>>
  </div>
