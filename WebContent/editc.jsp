<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <%Client a=(Client) request.getAttribute("c"); %>
<!DOCTYPE html>
<html>
<head>
<style>
...
<div class="col-6">
<div class="card">
  <h5 class="card-header">Modifier un client</h5>
  <div class="card-body">
   <form method="post" action="confirmedit.c">
  <div class="mb-3">
    <label for="exampleInputEmail1" class="form-label" >Nom</label>
    <input type="text" class="form-control" name="nom" aria-describedby="emailHelp" value=<%=a.getNom() %>>
  </div>
  <div class="mb-3">
    <label  class="form-label">Prénom</label>
    <input type="text" class="form-control" name="prenom" id="exampleInputPassword1" value=<%=a.getPrenom() %>>
  </div>
  <div class="mb-3">
    <label  class="form-label">Age</label>
    <input type="number" class="form-control" name="age" id="examp" value=<%=a.getAge() %>>
  </div>
  <div class="mb-3">
    <label  class="form-label">Adresse</label>
    <input type="text" class="form-control" name="adresse" id="exam" value="<%=a.getAdresse() %>">
  </div>
